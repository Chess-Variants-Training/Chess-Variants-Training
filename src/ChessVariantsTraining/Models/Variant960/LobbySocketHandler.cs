        ...
        async Task HandleReceived(string text)
        {
            ...
            switch (message.Type)
            {
                ...
                case "join":
                    ...
                    Game game = new Game(gameRepository.GenerateId().ToLowerInvariant(), hostIsWhite ? joined.Owner : client, hostIsWhite ? client : joined.Owner, joined.FullVariantName, nWhite, nBlack, joined.TimeControl);
